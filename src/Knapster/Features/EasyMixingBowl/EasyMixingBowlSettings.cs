...
[JsonObject]
public class EasyMixingBowlSettings : FeatureSettings, IEasyFeatureSettings
{
    /// <summary>
    ...
    /// <summary>
    ///     When the mode is set to `Whitelist`, only the players on this list will have the EasyMixingBowl feature enabled.
    /// </summary>
    public List<Player> Whitelist { get; set; } = [];

    /// <summary>
    ///     When the mode is set to `Blacklist`, the players on this list will have the EasyMixingBowl feature disabled.
    /// </summary>
