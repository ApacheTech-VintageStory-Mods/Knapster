...
{
    [HarmonyPrefix]
    [HarmonyUniversalPatch(typeof(BlockQuern), nameof(BlockQuern.OnBlockInteractCancel))]
    ...
    [HarmonyPostfix]
    [HarmonyUniversalPatch(typeof(BlockEntityQuern), nameof(BlockEntityQuern.GrindSpeed), MethodType.Getter)]
